advancement revoke @s only hsj:ender_eye
...
execute if score $distance hsj.dummy <= $max_distance hsj.dummy at @n[type=minecraft:marker, tag=hsj.iris.targeted_block] run function hsj:ender_eye/at_block