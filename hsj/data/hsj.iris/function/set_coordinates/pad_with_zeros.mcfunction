#> hsj.iris:set_coordinates/pad_with_zeros
#
...
#
# @within hsj.iris:set_coordinates/main
# @input
#   value
#       A numeric value between 0 and 999999
# @writes
#   storage hsj.iris:data String
#       The resulting string

$data modify storage hsj.iris:data String set value "000000$(value)"
